...
int main() {
    ...
    cin >> timesAddFront;
    if (timesAddFront)
        cout << "Please input namesAddFront:\n";
    while (timesAddFront--) {
        cin >> name;
    ...
    cin >> timesAddBack;
    if (timesAddBack)
        cout << "Please input namesAddBack:\n";
    while (timesAddBack--) {
        cin >> name;
    ...
    while (timesRemoveFront--)
        dLinkedList->removeFront();
    
    cout << "Please input timesRemoveBack: ";
    cin >> timesRemoveBack;
    while (timesRemoveBack--)
        dLinkedList->removeBack();
